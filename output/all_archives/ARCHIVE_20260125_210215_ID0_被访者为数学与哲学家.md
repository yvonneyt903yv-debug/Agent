...
> 存档时间：2026-01-25 21:02:15
> 敏感性判断：False
> NotebookLM 播客：

## 【Gemini 结构化分析】
**简介**：被访者为数学与哲学家大卫·伯林斯基、普林斯顿大学数学教授瑟吉乌·克莱纳曼，以及科学与文化中心主任、科学哲学家斯蒂芬·迈耶。
**要点**：
['• 文章围绕数学的本质展开，探讨了“2+2=4”这类数学真理为何具有超越物理观察的、客观非物质的实在性，并以此质疑唯物主义的局限性。', '• 核心争论在于数学是人类的“发明”还是对预先存在的概念世界的“发现”。多数嘉宾倾向于“发现论”，认为数学真理独立于人类心智而客观存在。', '• 讨论了数学在自然科学中“不可思议的有效性”之谜：为何源于心智的抽象数学能如此精确地描述和预测物理世界，暗示了人类理性与宇宙内在理性之间存在深刻共鸣。', '• 提出了对数学实在性的一种神学解读，即这些独立于人类心智但又具备概念性的数学真理，其最终源头可能存在于一个超越性的“上帝之心”中。']
...
## 【中文全译文】
# 为什么 2 + 2 = 4？数学如何揭示深层现实（文字稿）

**编辑按**：在本期《不寻常的知识》中，**主持人**彼得·罗宾逊与大卫·伯林斯基、瑟吉乌·克莱纳曼及斯蒂芬·迈耶进行了一场关于数学神秘本质及其与现实关系的深刻对话。这场探讨深入揭示了为何像"2+2=4"这样的简单真理具有超越物理观察的客观、非物质的实在性。嘉宾们探讨了数学究竟是人类的发明，还是对预先存在的概念世界的发现，并最终质疑了唯物主义在解释宇宙深层结构时的局限性。

**文字稿**：

**彼得·罗宾逊**：2 加 2 等于 4。在任何地方、任何时间，2 加 2 都等于 4。但这是为什么？数学告诉了我们关于现实本质的什么？

大卫·伯林斯基、瑟吉乌·克莱纳曼和斯蒂芬·迈耶，即将在《不寻常的知识》展开讨论。

欢迎来到《不寻常的知识》，今天我们于奥地利萨尔茨堡录制。我是彼得·罗宾逊。

大卫·伯林斯基曾在斯坦福大学、罗格斯大学、纽约市立大学、巴黎大学等多所高校教授数学、哲学和英语。他著有《1，2，3，绝对初等数学》等书，其即将出版的著作是《永恒的玫瑰》。

瑟吉乌·克莱纳曼出生于罗马尼亚，是普林斯顿大学的数学教授。用他自己的话说，他目前的研究兴趣包括黑洞的数学理论，更具体地说是其刚性与稳定性，以及陷俘面与奇点的动态形成。瑟吉乌，也许待会儿我会请你稍微解释一下这些。

发现研究所科学与文化中心主任斯蒂芬·迈耶，职业生涯始于地球物理学家。他重返校园，获得了剑桥大学的科学史与科学哲学博士学位。他已确立了自己作为美国智能设计领域领先思想家之一的地位。他的最新著作是《回归上帝假说》。

大卫、瑟吉乌、史蒂夫，欢迎你们。

## 第四项进展：数学作为超验性的证据

在史蒂夫的最新著作《回归上帝假说》中，他提出，三项相对较新的进展表明科学需要回归某种超验概念，这三项进展分别是：大爆炸、宇宙的微调以及DNA的发现。

在阅读了史蒂夫的书之后，一位非常杰出且知名的数学家将史蒂夫拉到一边说："你只提到了三项暗示超验心智的进展，还有第四项。"瑟吉乌，你这么说是什么意思？

**瑟吉乌·克莱纳曼**：嗯，首先，我应该说，史蒂夫谈论的是"进展"，而数学是永恒的。我的意思是，数学已经存在了数千年，所以这样比较不太公平。但数学，根据其定义，本身就具有对其自身实在性的感知，我主张，这种实在性与物理实在性一样客观。

例如，黑洞就是如此，对吧？根据定义，黑洞，我们拥有预测黑洞的广义相对论数学理论，但根据定义，黑洞是无法被看到的。然而，我们能够断言它的存在。为什么？因为广义相对论是一个自洽的理论。

**彼得·罗宾逊**：那么，以此为例，黑洞可把我吓坏了。我相信我们还会回到黑洞的话题，但光是听到你关于刚性的工作，我的脑子就已经开始疼了。好吧。

用外行的话来说，也就是对我来说，2 加 2 等于 4 是真实的。那不是臆想，不是我们心智、心理过程或我们神经元中可能发生的偶然过程的产物。无论我认为 2 加 2 等于 3 还是 5，我都是错的。2 加 2 确实等于 4，这是客观真实的。

因此，存在着一种存在于我们之外的概念性的客观实在。它不是物质的。这实际上是一件大事。

**大卫·伯林斯基**：大卫耸耸肩。是啊，这当然是件大事。

我的意思是，“2加2等于4”是个有趣的例子，但你可以从更基础的概念中推导出这个生物学推论，这本身就是一个激动人心且有趣的事实。

你无需从一开始就断言“2加2等于4”，抱着“这就是我的立场，别无选择”的态度。你可以说：“我是从更原始的概念要素中推导出这一结论的。”但当你不断追溯，追问关于算术系统初始假设（即公理）的问题时，除了整个体系的一致性之外，你无法提供更多辩护——而发现自己处于这种境地本身就非常有趣。

**彼得·鲁滨逊**：那么，请允许我引用您书中的内容。没有比这更合适的了。在《一、二、三》中，我想这段话与刚才的观点一致——但愿如此，因为这说明我确实理解了您的意思。

引用如下：“无论是数字本身，还是它们所支持的运算，都无法被分析为某种更基础的东西而消失。数字本身就是基础。它们可以被更好地理解，被更准确地描述，但无法被更基础的事物所取代。”

**戴维·伯林斯基**：我依然认为这是对的。请记住，当你说“2加2等于4”时，这是一个断言。

**彼得·鲁滨逊**：是的。

**戴维·伯林斯基**：我在那段文字中要论证的是：当你追溯算术的基础，期望或希望可以摆脱数字时，你会大失所望，因为它们总会再次出现。

## 数学论证的独特力量

**彼得·鲁滨逊**：好的。我将再次引用戴维的话，但这次想请二位共同评判。我假设他会同意自己的观点——不过在戴维这里，这总是个问题。

再次引用他的著作《一、二、三》：“在提出、评估、接受、推迟、延迟或驳斥的众多论证中，唯有数学领域的论证具备迫使人信服的力量。尚无任何哲学理论能解释其原因。这正是数学的神秘之处。”

因此，当你提出源自亚里士多德的哲学观点时，它看似合理，但我仍可以说“我未被说服”。但当你说“2加2等于4”时，我却不得不承认：“当然，你说得对。”

**斯蒂芬·迈耶**：我可以从自然科学工作者和科学哲学家的角度谈谈这一点。自然科学通过实证观察证据来支持结论，科学家会通过比较不同理论或假说的解释力、预测力来评估它们。

但这类论证的逻辑形式并不能得出必然的演绎结论。在最佳情况下，你只能通过推论选择那个能提供最佳解释的假说。

**彼得·鲁滨逊**：请稍等。请为我们区分一下演绎和推论。

**斯蒂芬·迈耶**：演绎论证始于一个大前提：“所有人都会死。”一个小前提，关于世界的某个事实：“苏格拉底是人。”然后得出结论：“因此苏格拉底会死。”如果前提为真且推理有效，结论就可以被确定地肯定。

但在自然科学中，你从观察到的世界事实出发，想要从这些事实推断出某种概括性规律（这属于归纳论证），或是推断出能解释所见现象的某种因果过程。

这类论证通常被称为溯因推理，就像我们看侦探剧时欣赏的那种侦探推理方式。

**彼得·鲁滨逊**：没错，比如哥伦布探长试图找出真凶。

**斯蒂芬·迈耶**：因此，当你分析这些溯因和归纳推理的逻辑形式时，会发现它们无法给你确定性结论。它们可能提供合理性，可能给出相对可信度……

在某些情况下，一个理论明显优于另一个，但它们无法提供数学和数理逻辑所能给予的那种确定性。

**彼得·罗宾逊**：优秀的科学家最多只会说："该理论是X、Y、Z，根据现有最佳证据，它目前成立。"而数学家则会信心十足地表示："我已经证明它了。"

**塞吉乌·克莱纳曼**：我们证明了它。我们拥有证明。在科学中我们不谈"证明"。然而，数学家比我们更严谨。当你说证明了某件事时，你就是确凿无疑的。

**戴维·伯林斯基**：是的。

**彼得·罗宾逊**：好的。明白了。请继续。

**塞吉乌·克莱纳曼**：证明可能出错，但总会有人向我指出错误。

## 数学在自然科学中不可思议的有效性

**彼得·罗宾逊**：这就引出了塞吉乌在《推论》杂志上发表的文章——戴维，这本杂志由您主编。文章题为《对维格纳论文的反思》。

需要说明的是，尤金·维格纳是20世纪的数学家和物理学家。1960年，他撰写了著名论文《数学在自然科学中不可思议的有效性》。维格纳指出，数学毕竟是在我们头脑中进行的活动，却能如此有效地描述甚至预测物理世界的各个方面，这令他感到惊奇。

能否举几个例子？比如我半夜做了个梦，醒来发现是假的。但如果我完成了一个数学等式，醒来后它依然成立。

**斯蒂芬·迈耶**：塞吉乌写了篇精彩的文章。他论证了可以从简单的数学出发，通过演绎逐步构建出越来越复杂的数学体系。而微积分、微分方程等复杂数学形式，能完美映射物理世界，描述自然界实际发生的过程，从而为自然现象提供精确描述。

维格纳提出的谜题在于：为何通过演绎步骤（本质上源于我们自身推理）发展的数学，能如此完美地映射到有时我们尚未观测到的自然过程？戴维在书中列举了多个精彩案例：有些数学结构在获得物理学应用之前早已发展成熟，后来却变得至关重要。或许该请他谈谈这点。

**戴维·伯林斯基**：维格纳提出了值得探讨的深刻问题。纵观理论物理的伟大体系——牛顿力学、广义相对论、量子力学——都离不开大量数学工具。维格纳质疑道：我们需要数学来构建量子力学，却不需要昆虫学。为何量子力学涉及数字和复数，而非昆虫？这是个发人深省的问题，但其实不必局限于量子力学。

比如这里有一个玻璃杯，那里还有一个玻璃杯，您面前共有几个？

**彼得·罗宾逊**：两个。

**戴维·伯林斯基**：您如何确信面前有两个杯子？这并非物理观测，因为物理情境本身不会呈现"一加一等于二"的概念。这显然是额外赋予的认知。

逻辑学家在20世纪已将证明方法分解为极小的步骤，小到计算机可执行的程度。初始假设可以变得极其普适，甚至能通过集合论或范畴论囊括全部数学体系。

或者这么说。

但我们现在的处境相当尴尬。我正好望着窗外美丽的阿尔卑斯湖，想象一下我们看到对岸有人开始在水面上行走，没有任何辅助工具。他就这样一步步走着，用最普通的步伐向我们走来，到达时全身干爽。

他出现在电视镜头前，我们问："你是怎么做到的？"他回答："嗯，我的步子迈得很小。步子非常小。"

我们的本能反应会是：值得称赞。你确实成功渡湖了。但这答案总觉得不对劲。就像目睹有人横渡大湖后，用"看我的脚步，小步子"来解释成功一样。这就是我们目前的处境。

## 发现还是发明？

**彼得·罗宾逊**：好的。塞尔久，让我们回到你的文章。我再次引用你的话："维格纳指出的谜题部分源于那个永恒的问题：数学究竟是像物理学理论那样通过探索发现推进的科学，还是人类思维的发明创造？"

我认为数学是通过探索和发现发展的。就像地底的金矿，需要人去发掘。

**塞尔久·克兰曼**：完全正确。打个比方：就像登山者想要登顶。今天大家都很喜欢用阿尔卑斯山作比喻——但登山者清楚目标在哪里对吧？这很重要。数学工作也是如此，不只是演绎推理，还需要对目标方向有直观把握。

**彼得·罗宾逊**：还需要灵感。

**塞尔久·克兰曼**：对，与灵感有关。但更重要的是，你面前有非常客观的存在。就像登山者必须确认岩石稳固，必须亲手触摸岩石确认路径，否则就会陷入困境。

数学研究很相似。人们总以为数学全靠演绎，其实不然。这点和自然科学很像。做研究时你会先有预期，提出假设对吧？假设的选择不是演绎过程，而是直觉洞察。

然后你试图证明这个假设能解释所有其他现象。这就是证明的过程——既有发现的过程，也有验证的过程。

**彼得·罗宾逊**：验证的过程。

**塞尔久·克兰曼**：数学最终呈现为逻辑链条，计算机也能处理。一旦形成链条，计算机可以快速验证——虽然目前只能验证小规模证明。

这是个很好的例子。几何学就是说明数学与物理关系的典型。几何学是最早的物理理论，它描述的就是物理世界。

**彼得·罗宾逊**：追溯到欧几里得？

**塞尔久·克兰曼**：没错。欧几里得试图建立数学表述，但几何学本质是物理理论。后来才逐渐发展成独立体系。

## 数学发现的自由与美

这里体现出数学区别于物理的特质。数学家可以基于与物理学家完全不同的标准来发展理论。他们研究问题可能纯粹因为问题本身的美感，或是认为这能促进对其他领域的理解。

A

而这种自由，在几何学领域，持续了大约两千年，基本上与物理世界没有任何联系。我的意思是，欧几里得几何最初就是存在的。但到了19世纪，出现了高斯、罗巴切夫斯基、黎曼，以及在20世纪初出现了闵可夫斯基。

然后突然间，所有这些理论都变成了不可或缺的要素。我的意思是，它不仅仅是技术性的，更是狭义和广义相对论的核心组成部分。它直接应用于基础物理理论。我认为这种情况已经发生过很多很多次，只是可能没有得到很好的承认。

## 数学工作的美学

**彼得·罗宾逊**：那么我想问一下，瑟久，不用说，我无法自己去评估你的工作，因为你完成了一个长达2000页的证明，2000页缜密的数学推理。就算我活到2000岁，每天读一页，或者每年读一页，我相信我也还是理解不了。而这项工作是关于爱因斯坦理论的某个方面的稳定性。那么请问，你认为你是在创作一件艺术品，创造某种美的东西，还是认为你是在探究现实？你明白我的意思吗？我试图理解，作为一名致力于解决深刻而困难问题的数学家，你当时的感受是怎样的。

**瑟久·克莱纳曼**：答案是两者兼有。我的意思是，首先我会选择这个问题。我是一名数学家，不是物理学家。我相信最好的数学总是以复杂的方式与物理学相联系。但是物理学中有很多问题，我会选择那些能满足我作为数学家的美学感受的问题。

**彼得·罗宾逊**：你的美学感受，请解释一下。你是想要某种美的东西吗？

**瑟久·克莱纳曼**：我感觉到非常优美、非常深刻、并能引发出许多非常有趣问题的东西。好，这是一个方面。但对我来说，至少还必须有第二个方面，那就是它应该对物理世界有所阐述，而在目前这个案例中，它确实做到了，对吧？

## 克尔解与数学实在

我的意思是，克尔解的情况是这样的，对吧？你有广义相对论，这是爱因斯坦在1915年底完善表述的，抱歉。这在当时是一种新的引力理论。大质量物体会弯曲所谓的时空。然后人们发现了一些特定的解。

史瓦西是第一个在1916年，也就是一年之后，发现了所谓的史瓦西解，这是一个具有许多对称性的稳态解，你可以从相对论、从爱因斯坦场方程中提取出精确的公式。这引发了很多问题，因为它有一个奇点。这后来与彭罗斯的奇点定理有关，他也因此获得了诺贝尔奖。

**彼得·罗宾逊**：他是唯一一位获得诺贝尔物理学奖的数学家，尽管没有其他人了。

**瑟久·克莱纳曼**：我猜是因为数学如此完美地应用于物理学和宇宙学。

**彼得·罗宾逊**：没错，或者说应用于一个非常重要的问题。

**瑟久·克莱纳曼**：然后是克尔的第二个主要发展，这是在1963年，克尔解出现了。好，所以现在你有了一个克尔家族，其中包含了史瓦西解。这是一个庞大的家族，取决于两个参数。所以这些是爱因斯坦场方程的精确解，对吧？

我的意思是，从数学的角度来看，它们是真实的，因为对我来说，数学的实在性与这样一个客观事实有关：这些是一个你可以从概念上写下来的方程的解。

## 爱因斯坦的不朽理论

**彼得·罗宾逊**：我能打断一下吗？那么，如果我没理解错的话，关于爱因斯坦的一个非凡之处在于——当然，如果我说错了请纠正我，我在这里说的是很浅显的话——

在处理这类材料时，我的状态总是特别投入。爱因斯坦在1915年提出了广义相对论。如今已是2025年，在这过去的一个世纪里，随着新卫星和新技术的出现，我们不断进行着各种实验。

而每一次实验都验证了广义相对论的正确性。也就是说，爱因斯坦在黑板上推导出的这个理论，历经百年实验验证，始终与客观现实相符并能预测现实。如果我们能设计出关于黑洞的实验，您的研究成果也将从某种程度上证实其真实性。

**SERGIU KLAINERMAN**：我喜欢称之为现实检验。克尔解是稳定的——这是一个数学表述，但蕴含着丰富的物理内涵。因为假设它不稳定，虽然它仍是爱因斯坦方程在特定初始条件下的正确解......

但稳定性问题的关键在于：当我们对初始条件进行微扰时，是否会得到与克尔解完全无关的结果？如果会，那就是不稳定性。若克尔解不稳定，就意味着它不具备物理意义——因为自然界中找不到与之对应的实体。

因此稳定性问题本质上是......一种现实标记。我称之为对现实的数学检验。

## 数学与物理的理性内核

**PETER ROBINSON**：彼得，请为我们解析当下讨论的本质。

**STEPHEN MEYER**：好的，这非常有趣。从哲学视角来看，这里存在一个深层假设：数学上具有一致性、连贯性和稳定性的理论，能够指引我们认识物理现实——仿佛物理学内在的理性与我们进行高等数学时的理性产生了某种共鸣。

这就是维格纳之谜：为什么人类内在的理性会与外部自然界的理性相契合？

**PETER ROBINSON**：现在我们进入了深水区。虽然已经超出我的理解范围，但我仍会继续探索。

**STEPHEN MEYER**：这确实深奥。请允许我举个简单的例子：虽然我们讨论了广义相对论的场方程和解，但瑟吉乌最初是从几何学切入的。数学对象具有稳定属性——这正是数学家视其为实体的原因。

比如圆具有特定基本属性：周长和面积可计算，这些属性对所有认知圆的人来说都成立。几何对象拥有的稳定属性可以通过数学描述，且独立于人类意识。

正如瑟吉乌在近期会议上阐述的，这种稳定性是客观现实的表征，是独立于意识的客观实在。因此数学家普遍认为他们是在发现而非发明数学公式。

## 发现与发明之辩

**PETER ROBINSON**：虽然存在少数反对声音，但有趣的是物理学家总称数学是人类意识的发明——维格纳也持此观点。

**SERGIU KLAINERMAN**：抱歉打断，爱因斯坦说过数学是"人类意识的自由创造"，维格纳也有类似表述。我始终对此感到惊奇。

**PETER ROBINSON**：爱因斯坦认为自己发明了广义相对论？

**SERGIU KLAINERMAN**：不，不。爱因斯坦认为数学家是在发明，他确实将数学称为"人类意识的自由创造"。

**戴维·伯林斯基：** 他这话是什么意思？其实并不清楚，因为如果数学真是人类思维的自由创造，那为什么数学命题如此具有必然性？对于二加二等于四，我并没有多少选择的余地。我想你也没有。这与自发地、即兴地创造出像加法这样的发明的概念有点矛盾。它看起来根本不像是一种发明。

**塞尔吉乌·克莱纳曼：** 但我有一个理由解释物理学家为什么会这样想，而且我怀疑牛顿会这么说。这是现代的、是现代的物理学家们，他们是唯物主义者。他们确实相信只存在物质，而一切事物，包括思维，都必定是由某种方式决定的。但他们在这一点上不可能是对的。

**斯蒂芬·迈耶：** 好的。那么请注意这里讨论的辩证关系，那些研究数学、发展数学的数学家们，通常相信他们是在发现某种真实且独立于他们思维的东西，而不是在发明某种像内燃机一样的东西……

**塞尔吉乌·克莱纳曼：** 正是。我的意思是，任何发明都必须有一个起点，对吧？这意味着在那个起点之前，那个数学事实并不存在，对吧？毕达哥拉斯定理在毕达哥拉斯发现它之前并不成立。这听起来有点荒谬。

## 对唯物主义的挑战

**彼得·罗宾逊：** 但是，任何人怎么可能……这里肯定有复杂之处。我确信有复杂的地方。我可能还没完全理解，但二加二等于四对我而言是真理。对你也是真理。对戴维也是真理。无论戴维在某个时刻感觉多么别扭，它依然是真理。它是真理，并且自古至今都是真理。

因此，存在着某种东西，难道这不就直接击中了唯物主义的要害吗？存在着某种外在于我们的东西。某种东西，我们可以称之为理性，我们可以称之为……好吧，那我们谈谈柏拉图。

如果我理解得没错，在《理想国》中，柏拉图区分了可知世界和可感世界：可感世界是我们能看到和触摸的，而可知世界是我们能够通过智力理解的。柏拉图把他的理想形式置于那个可知世界。那里存在着一个理想的“圆”。那里存在着一个理想的“三角形”。

柏拉图说它确实具有独立的存在，但他似乎暗示在某处存在一个理想形式的领域。一千五百年后，阿奎那出现并说道，理念存在于心灵之中，而那对我们所有人、对所有时代都成立的真理，虽然是可知的但却是非物质的，它存在于上帝的心中。

戴维，你怎么看？

**戴维·伯林斯基：** 嗯，也许吧。

**彼得·罗宾逊：** 戴维刚才那一刻的表现，真是典型的戴维风格。

## 根本的困境

**戴维·伯林斯基：** 我完全听不懂到目前为止的讨论。这是我的问题。维格纳指出的那个问题是一个真正的哲学问题，即：如果数学对每个物理理论都至关重要，那么就不可能（除非是一种微不足道的解释）存在一个能用物理学来解释数学的物理理论。

我的意思是，如果一个人想用鲤鱼作饵去钓鲤鱼，那他就是在做徒劳无功的事情。他已经有了鲤鱼。如果我们需要一个包含数学的物理理论来解释数学本身，那我们得到的就不再是一个纯粹的物理理论了。我们得到的是一个物理和数学相结合的理论。我认为，这就是维格纳所指出的那个困境，那个深刻的困境。

有一些原则我们想要坚守。这是文化使命的一部分。我们想要坚守“世界是物质的”这个基本观念。我们生活在一个物质世界。我并不是说这个观念值得称赞。我是说这是一种文化使命，因为它让人感到安心。

你看，我们面对的是难以估量的事物。基本事实是，事物是物质的或物理的对象。从文化和智识上讲，得出这样一个结论是非常不便的：为了理解……

要理解那个物理对象，我们需要大量关于数学的非物理事实。

而为了解释大量关于数学的非物理事实，任何没有数学的物理理论都无法完成这项解释工作。所以我们陷入了一种境地：如果数学真的像塞尔久和史蒂夫说的那样有用（他们说得完全正确，数学在日常生活中确实有用），那么我们那种将世界视为物理系统的根本观念就存在严重问题。

有些事情肯定不对劲。必须有所舍弃。要么我们发展出完全不依赖数学的物理理论——费曼曾推测过这种可能性；要么我们承认唯物主义根本就是错误的。二者必居其一。但总得有东西要被抛弃。

**塞尔久·克莱纳曼**：但物理学家们，至少到目前为止，还没有给出关于物理性的观点。

**戴维·伯林斯基**：确实。所以这就是问题所在。

**史蒂芬·迈耶**：但他们并没有认真对待戴维刚才描述的那个困境。

**塞尔久·克莱纳曼**：不包括我。我的意思是，那个困境在文献中已经存在至少50年、60年，甚至100年了。

## 学术界为何忽视这个困境

**彼得·罗宾逊**：我不明白。你们这些聪明人，如果某个问题在文献中存在了半个世纪，这本质上就像一个停止标志，在说：等一下，等一下，等一下！你们需要在此对实在的本质做出一个基本决定。那么学术界怎么就能忽视它？你们这些学者怎么就能忽视它？

**塞尔久·克莱纳曼**：好吧。我不知道为什么。我不想讨论存在、理念、柏拉图理念这些问题。也许那一步迈得太远了。这可能是我们的共识。

但我对实在有一个操作性的定义。实在是某个特定对象的各种表征之间的一致性。我的意思是，这在物理学中成立，在数学中也成立。数学对象是实在的。一个研究数学问题的数学家，用这种方法计算，用另一种方法计算，总是得到相同的结果。

我的意思是，我们的工作显然具有某种客观性，对吧？声称这些只是人类心灵的发明，在我看来是荒谬的。当然，在哲学上，任何立场都可以找到辩护的理由。

**戴维·伯林斯基**：我是说，我们也可以主张它们是心灵的发明，因为心灵是唯一真实存在的东西。毕竟，有一个非常崇高的传统，可以一直追溯到贝克莱，他提出的正是这个论点——“存在就是被感知”。

## 物理实在的局限

但是，有些事情阻碍了我们回归贝克莱式的唯心主义，因为说唯一存在的东西是心灵，这听起来有点荒谬。这与我们讨论过的那些宏伟的物理理论不相容。就是不相容。这不是论证，只是一个观察。

但话虽如此，我们确实面临着被缩减到一个不断变窄的浮冰上的危险。塞尔久刚才提到的那个浮冰，就是表征的一致性。“表征”是个有点模糊的术语。我们为什么不回到基础呢？

那就是我们理论的一致性。那么，理论是什么？我们可以给出一个答案：理论是一大组语句。

语句又是什么？它们是做出某种断言的东西，这些断言可以为真或为假。如果它们是一致的，这差不多就是我们在理论的可信度和可取性方面能达到的最好程度了。所以我们现在被缩减了，我们的浮冰就是说：好吧，我们有一个关于物理世界的表征或理论，它是一致的。

但当我们审视它时，我们发现它本身并不是一个物理对象。它援引了非物理的实体，比如数学对象。我们不必说，我们无需做出决定。它们究竟是存在于心灵中，还是存在于外部世界中？

它们存在。这就够了。数字2是存在的。我不必告诉你，它存在于你的脑海里，它存在于我的

这无关紧要。它存在。这才是决定性的事实。既然它存在，并且我们承认它不是物质性的，那么我们就不得不面对这样一个问题：为什么我们对物质世界最完善的描述会包含非物质的成分？

为什么会这样？"存在"是一个本体论问题。我更倾向于使用"实在"这个我能把握的概念。"存在"嘛，我不太确定。

谈到存在的问题时，我感到迷茫。**彼得·罗宾逊**：你感到迷茫？**斯蒂芬·迈耶**：我是说，我不知道什么存在、什么不存在。真正让我感兴趣的是，那些数学对象——无论是二次方程、圆形还是更高级的数学形式——都具有稳定的属性。

**彼得·罗宾逊**：这就是您所说的"一致性"吗？

**塞吉乌·克莱纳曼**：我说的是实在。是的，我更愿意称之为实在性、客观性、一致性。**斯蒂芬·迈耶**：是的，塞吉乌的意思是，这些数学结构或对象具有一种实在性，这种实在性独立于我是否亲自确认这些属性。

## 独立于心灵的数学实在

**斯蒂芬·迈耶**：它们在本质上是独立于心灵的，但又是概念性的。它们不是物质的，而是概念的。这确实引出了一个问题：它们存在于何处？如果概念存在——这正是我们引入柏拉图思想所要探讨的方向。

柏拉图认为存在某种概念性的实在，它们存在于某种理念世界中，但阿奎那对此的批评是，这与我们的经验不符。观念存在于心灵中。因此，如果数学结构具有独立于我们心灵的客观属性，并且这些数学结构本身是概念性的，那就意味着它们并非漂浮在某处，而是从根本上起源于或存在于某个超越性的心灵之中。这是对数学实在论的一种有神论解读。

**彼得·罗宾逊**：史蒂夫说数学存在于上帝的心灵中，而塞吉乌则表示："别拿这个来烦我，我是个实干数学家，我只需要一支粉笔和一块黑板。"这是对实在的操作性定义，对吧？

**塞吉乌·克莱纳曼**：那种认为所有实在的东西都必须是物理的观点，在我看来是说不通的，因为数学对象也是实在的。我认为我们都在表达同一个意思，无论你从哪个角度切入……

**戴维·伯林斯基**：是的，我觉得这完全正确。我的意思是，即使我们采纳贝克莱"存在即被感知"的立场，我们最终也会得出同样的结论：一个彻底一致和连贯的宇宙观绝不可能是纯粹物理的。

它绝不可能是自由的。

**彼得·罗宾逊**：好吧。即使以我浅薄的头脑来看，这也确实显得相当深刻，我不称之为洞见，而称之为发现。这本身就是实在的一个真实侧面。

## 复数的奥秘

**彼得·罗宾逊**：我能回到刚才谈话中较早的一个话题吗？当然可以。是戴维书里提到的一件事。他有一次在美国就此做过演讲，我觉得非常有意思。

我记得好像是在第一年或第三年的年鉴里提到的，当时你正在巡回演讲。他展示了，我想是关于复变函数，也就是复数。还记得数学里的虚数单位吗？围绕复数已经发展出一整套数学体系。

这看起来似乎与现实毫无关系，但却存在一整个关于它的数学分支。我在研究生院修过复变函数课程。戴维指出，这个体系大概是在……多少年前被发明出来的？140年？是发展起来的吗？

还是发现的？140年？也许是200年前。然后你看，它对于量子力学——我们最基础的物理理论之一——来说变得至关重要。

关于虚数单位i的发明史，最引人入胜的一点是，嗯，它出现在14世纪的意大利，14到15世纪。16世纪？不，更早一些。

我想是145...

但是无论如何，他们的动机源于求解方程的愿望。所以他们首先想解二次方程。其实公式早已存在。阿拉伯人显然也已经知晓。

不管怎样，他们开始研究三次方程，并发现引入这个符号——负一的平方根——很有用，尽管这看起来毫无意义。负一的平方根怎么可能存在呢？但他们就这样引入了。并且他们做出了一个惊人的发现：可以利用这个数。

最终，他们得到了三次方程的实数解。这些解本身与复数无关，但复数却出现在了求解公式中。这非常奇妙，不是吗？于是渐渐地，人们开始习惯使用负一的平方根。

到了19世纪，这一概念变得更加形式化。负一的平方根被赋予了几何定义。继而发展出复数和复变函数理论，并产生了大量的应用。

所以，负一的平方根显然是真实存在的。它在被发现之前就已经存在了。但这里有一个非常有趣的……我在九年级时犯过一个基本错误。

当时老师讲到负数，我就没再认真听。我觉得负数与现实毫无关系。但后来我意识到我错了。彼得，问题不在负数本身。

我们现在讨论的是复数，是负一的平方根。负数指的是-1、-2这些，比如用来表示债务。

但现在我们谈的不是债务，是复数。关键在于，15世纪有位古怪的意大利数学家发现，如果我引入符号i表示负一的平方根，就能建立完整的推理链条，并最终得到正确的解。

这绝对令人惊叹。然而，当数学家深入思考后发现，完全可以用两个实数及其运算规则来取代负一的平方根。

这样一来，负一的平方根就消失了。你剩下的只是最初就存在的实数，比如3和7，按照特定顺序和规则进行运算。其中乘法规则至关重要。这就是复数的本质。

复数。没错。它引入了一种实数域中原本不存在的新乘法规则。但这引出了一个深刻的分析观点：本体论问题可以通过一套规则系统来简化。

## 减轻本体论负担

你可以减轻数学的本体论负担。比如，你可以用集合来定义数；用实数有序对来定义复数；用收敛数列来定义实数。

你可以不断简化。但是，当你减轻本体论负担的同时，却增加了规则体系的复杂性。所以你永远无法让数学从无到有地显现。

就像生物学家……本体论关乎什么是真实存在，是实质性的实在。19世纪的生物学家喜欢说“生命只源于生命”。这显然是真理。

生命只源于生命，而生命如何能从非生命产生则完全是个谜。同样，语言也只源于语言。数学也只源于数学。这些我们熟知的过程，似乎都没有一个绝对的起点。

数学没有起源之地。语言没有起源之地。生命也没有起源之地。它们很可能是宇宙本身的基本特征。

尽管如此，数学有其发展历史。但它是无限的。这发生在过去。是的。

我是说，它是人类…

所以数学确实有其人性化的一面。我们探索数学的历史，但数学真理本身没有历史。确实如此。

是我们人类在发现数学。我们探索的方式。好的，大卫，这是你最近在……

这是你和史蒂夫在剑桥的一次对话，我引用一段话："举起一根手指。这根手指的颜色可能不同吗？"

"可能。它可能稍微长一点吗？可能。它可能弯曲吗？"

"可能。但它可能不是一根手指吗？不可能。数量是固有的属性。"

"数量是手指本质具有的特性。" 好了，现在我们进入了亚里士多德的领域，讨论本质属性与非本质属性的区别。

## 本质属性与偶然属性

以及偶然属性。本质属性与偶然属性。请解释一下。嗯，我感觉我正小心翼翼地……

你做得很好，罗宾逊。好吧，好吧。数字代表了现实的一个本质方面。

这很重要。嗯，这是个非常笼统的说法。我更倾向于……请原谅我……

请原谅我引入海德格尔的观点。我更喜欢他的表述。海德格尔……我承认，他的著作中有一些非常有趣的段落。

他说，当我们观察物体时，我们无法将这只玻璃杯的"一"这个属性与物体本身分离开。但我们可以改变它的颜色，可以改变它的形状，它仍然是同一个物体。但我们不能说这一个物体原本可能是两个。这根本说不通。

所以当我们谈论物理物体时——我们现在只讨论物理上可实现的物体——它们的数学属性是本质性的。适用于数字的规律同样适用于形状。我们不必像尤金·维格纳那样，看着量子力学惊叹于希尔伯特空间需要引入复数这个非凡事实。

不，只需看这个玻璃杯。玻璃杯本身就需要引入自然数的概念。两个玻璃杯就需要引入两个自然数。这与量子场论中引入复数同样神秘。

同样神秘。而我们并不完全明白其原因。好的，那么你们三位都愿意同意，你们都坚持认为数学的存在，数学以这种奇特方式与现实对应并帮助我们探索真实现实的方式——我反复使用"现实"这个词——证明了现实并不纯粹、也不仅限于我们通过五种感官所能触及的范围。这是一个暗示。

它并不能证明。只是一个暗示。哦，现在连这点我都觉得站不住脚了。哦，所以我们只有一个暗示。

那么为什么你，我认为史蒂夫愿意……瞧，我又在替史蒂夫说话了。史蒂夫愿意说，我们在这里是在探讨上帝的思想。我认为大卫的意思是……大卫无论如何都不会那样做……

即使我逼你，你也不会……我举个例子来说明这类情况。你知道，牛顿之后紧接着是牛顿力学。当时的观念是牛顿力学必须解释一切。

然后出现了麦克斯韦，麦克斯韦方程组，而为了将麦克斯韦方程组与牛顿力学调和，他们需要以太这个概念，对吧？

## 超越唯物主义

所以，你知道，以太在这里指的是……在某个时刻，我的意思是，爱因斯坦的伟大洞见是我们不需要它，对吧？所以我认为情况是类似的。我们不需要这种唯物主义的对世界的表述。干脆忘掉它吧。

现实意味着某种超越物质的东西。它与数学本身最显而易见的呈现方式是不一致的。很明显，数学属性不是物质的。你可以发明一套形而上学体系来解释这一点。

这就是为什么它不是一个证明，但是……没有人证明以太不存在，对吧？我们只是摒弃了它。我认为我们对唯物主义也应该这样做。

**STEPHEN MEYER**：我想我可以同意这一点。但回到你的……

最后一点，彼得，我认为简单来说，奥秘就在于数学本身的存在。就是这样。因为这是根本性的。

**大卫·伯林斯基**：我们完全可以说，哲学家们也确实说过，我们可以抛开物理世界。从形而上学角度看，这不是问题。贝克莱已经证明了一切都是感知或观念。外部世界就这样消失了。

但我们无法抛开数学世界。那是无法消除的。它的存在就是一个深刻的奥秘。它为何存在？

我们为何用数学术语看待事物？我提出这个问题，并非因为我已有秘而不宣的答案。

**彼得·罗宾逊**：我本希望你能用答案来结束对话。

**大卫·伯林斯基**：我觉得这是个巨大的奥秘。数学纯粹的存在本身就令人深感困惑。你会完全同意这一点。

## 上帝之心与数学实在

**斯蒂芬·迈耶**：是的，我完全同意。你也会同意，但你能更进一步吗？我对之前对话中重述的那种论证很感兴趣，即数学对象具有稳定属性，因此它们具有独立于我们心灵的客观性，然而它们又是概念性的，这根据我们的经验表明，它们不可能只是漂浮在柏拉图式的天国某处，而更合理的解释是，它们最终源自上帝之心。

这正是数学能神秘地应用于物理世界的深层原因。

**大卫·伯林斯基**：史蒂夫，请记住，你得出的立场非常接近贝克莱的立场。

**斯蒂芬·迈耶**：谁的立场？

**大卫·伯林斯基**：贝克莱，贝克莱主教。

**斯蒂芬·迈耶**：你的意思是，如果说存在就是被感知——

**大卫·伯林斯基**：贝克莱主教，17世纪英国——

**斯蒂芬·迈耶**：18世纪。

**大卫·伯林斯基**：18世纪英国教会人士兼哲学家，他可能最著名地出现在博斯韦尔的《约翰逊传》中，博斯韦尔说——“我如此反驳贝克莱。”即约翰逊踢了一块石头。但关键是——

**斯蒂芬·迈耶**：贝克莱要面对一个明显的问题，如果你不看月亮——爱因斯坦也讨论过这个问题——月亮是否继续存在？贝克莱的回答是，是的，它作为上帝心中的一个念头而存在。这非常接近史蒂夫刚才的论证。

**大卫·伯林斯基**：虽然他肯定不是——

**斯蒂芬·迈耶**：我不是贝克莱主义者。是的，我不认为物理世界……我认为它具有独立性，既独立于我们的心灵，也独立于创造它的上帝之心。但我认为数学实在的最终源头很可能就是上帝之心。

不过有趣的是，你比许多当代分析哲学家都更愿意朝着贝克莱式的分析方向前进，我认为在这种情况下，这是唯一合理的分析。
...
**彼得·罗宾逊**：伙计们，我打算在这里提出最后一个问题。我尝试引入一个新概念，那就是美的概念。我不知道这会引出什么讨论。

但这里有一段即将上映的纪录片《万物的故事》的摘录。科学中有一种所谓的美原则，认为真实的理论往往传递着数学之美或结构上的和谐。弗朗西斯·克里克在观察他们的DNA分子模型后曾说：“它太美了，所以它一定是正确的。”

解释一下这一点。为什么美会参与其中？

**斯蒂芬·迈耶**：我们并不真正知道。但它往往被认为是科学中的一种启发式指南，一种发现的指导。在影片的后续部分，可能会有几位物理学家的更尖锐的评论，他们谈及在追求

我认为是保罗·狄拉克最先提出，理论的美观性比与数据的一致性更重要，因为我们可能会错误地理解数据。但这里存在一个假设，即现实本身具有数学意义上的美感。

**SERGIU KLAINERMAN**：可理解性。狄拉克对此着迷不已。

**PETER ROBINSON**：抱歉，您说的是哪位？

**SERGIU KLAINERMAN**：狄拉克，保罗·狄拉克。

**PETER ROBINSON**：我刚才提到了吗？我说的是狄拉克。狄拉克对此着迷。您之前谈到选择研究课题时，我记得您用了"优雅"这个词？还是"美观"？

**SERGIU KLAINERMAN**：美学价值。当然。克尔解是个不可思议的数学对象，确实非常优美。

**PETER ROBINSON**：我们是否触及了另一个奥秘？一种美学奥秘？

**SERGIU KLAINERMAN**：美观性在我们选择问题时起着根本作用，同时也指引我们寻找真相——也就是问题的解决方案。我们往往会排斥那些矫揉造作、缺乏美感的论证方式。

确实，这种现象神秘而真实。物理学中充满这类例证。以麦克斯韦为例——法拉第最早通过实验发现了电磁学的三大定律，但他并非数学家，只是陈述了这些定律。麦克斯韦则意识到，当把这些定律用数学语言表达时，会显现出不对称性。这种不对称性引导他提出了第四定律，从而建立了完整的电磁学理论。

**STEPHEN MEYER**：这正是现代世界所有技术的基础。

**PETER ROBINSON**：因为美观性？

**STEPHEN MEYER**：源于麦克斯韦。

**PETER ROBINSON**：关于美观性，您有何看法？

**DAVID BERLINSKI**：我想听听各位专家的见解。作为职业数学家，我可以肯定美观性在数学研究中具有根本性意义。几乎没有数学家会声称自己选择研究课题是因为其丑陋程度。人们总是基于某种审美取向来选择研究方向和问题......

**SERGIU KLAINERMAN**：这不过是官方说辞罢了。我们隐藏了各种数学研究的实际动机。没人会告诉我湍流研究是个优美的领域。

**DAVID BERLINSKI**：但这是个奇妙的领域。

**SERGIU KLAINERMAN**：奇妙但不优美，笨拙而臃肿。

**DAVID BERLINSKI**：但我们期待通过研究发现湍流中的美感......

**SERGIU KLAINERMAN**：期待总是廉价的。而美感往往千金难求。

**PETER ROBINSON**：好了，别让他继续诡辩了。他显然在故意捣乱。

## 牛顿与神圣心智

**PETER ROBINSON**：最后一个问题。艾萨克·牛顿在数学、天文学、流体力学和微积分领域贡献卓著。牛顿的解释颇具深意。引用他的一句话："有一位天上的主宰者以宇宙统治者的身份统管整个世界。" 

对超越人类心智的神性认知，自牛顿时代以来已被视为理所当然数千年。但后来这种认知被逐出思想界和学术界。

数学的奥秘是否表明，唯物主义错误是一种反常现象，现在应该也即将终结？史蒂夫，您同意这个观点吗？

**STEPHEN MEYER**：当然。我认为这个观点完全正确。牛顿的例证精彩地说明了我们讨论的可理解性原则——数学家无需观察自然就能发展的数学理性，确实适用于理解自然内在的理性结构。

这对于现代科学形成期至关重要......

科学革命时期，人们发展出了系统性的方法来探究自然、研究自然，最终涌现出像牛顿这样的人物——也许再没有谁能像他那样以如此深刻的洞察力，在短短一代人的时间里将自然哲学（即科学）推进到如此高度。

甚至就在一年之内，在他著名的"奇迹年"里，牛顿在瘟疫期间回家弥补自己在数学上的不足，归来时却已经发明了微积分。真乃天降宗师。

**彼得·罗宾逊**：大卫？

**大卫·伯林斯基**：好吧。我能说什么呢？那种洞察力可没有降临到我身上。这很公平。

**彼得·罗宾逊**：瑟久？

**瑟久·克莱纳曼**：嗯，好吧。首先，我认为唯物主义作为对世界的唯一解释，应该被扫进历史的垃圾堆。在这一点上我们俩意见一致。引入上帝，当然可以，为什么不呢？我的意思是，那是另一种看待世界的方式。

如果还有别的可能，那就去发现吧。也许还有另一种解释。但在目前，我看不出有任何理由不去考虑那种可能性。所以，上帝存在，嗯，有何不可？没错。

**彼得·罗宾逊**：瑟久·克莱纳曼、大卫·伯林斯基和斯蒂芬·迈耶。先生们，谢谢你们。
